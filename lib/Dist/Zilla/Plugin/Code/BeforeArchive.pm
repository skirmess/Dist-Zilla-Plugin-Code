...
Dist::Zilla::Plugin::Code::BeforeArchive - something that runs before the archive file is built
...
This plugin implements the L<Dist::Zilla::Role::BeforeArchive> role.
...
L<Dist::Zilla>, L<Dist::Zilla::Role::BeforeArchive>
