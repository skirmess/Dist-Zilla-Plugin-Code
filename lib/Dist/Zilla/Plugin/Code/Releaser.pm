...
package Dist::Zilla::Plugin::Code::Releaser;
...
Dist::Zilla::Plugin::Code::Releaser - something that makes a release of the dist
...
This plugin implements the L<Dist::Zilla::Role::Releaser> role.
...
L<Dist::Zilla>, L<Dist::Zilla::Role::Releaser>
