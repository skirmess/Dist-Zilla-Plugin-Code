...
package Dist::Zilla::Plugin::Code::TestRunner;
...
Dist::Zilla::Plugin::Code::TestRunner - something that tests the dist
...
This plugin implements the L<Dist::Zilla::Role::TestRunner> role.
...
L<Dist::Zilla>, L<Dist::Zilla::Role::TestRunner>
