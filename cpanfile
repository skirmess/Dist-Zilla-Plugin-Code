...
requires 'Dist::Zilla::Role::BuildRunner';
requires 'Dist::Zilla::Role::EncodingProvider';
requires 'Dist::Zilla::Role::FileFinder';
requires 'Dist::Zilla::Role::FileGatherer';
requires 'Dist::Zilla::Role::FileMunger';
requires 'Dist::Zilla::Role::FilePruner';
requires 'Dist::Zilla::Role::InstallTool';
...
requires 'Dist::Zilla::Role::VersionProvider';
requires 'Moose';
